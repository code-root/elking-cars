          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-end">
                ...
                <a href="<?=dashboard()?>" class="font-weight-bold" target="_blank"><?=NameSite?></a>
            ...
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="<?=dashboard()?>" class="nav-link text-muted" target="_blank">الصفحة الرئيسية</a>
                </li>
                <li class="nav-item">
                  <a href="<?=dashboard()?>customers/" class="nav-link text-muted" target="_blank">العملاء</a>
                </li>
                <li class="nav-item">
                  <a href="<?=dashboard()?>collectors/" class="nav-link text-muted" target="_blank">الإيرادات</a>
                </li>
                <li class="nav-item">
                  <a href="<?=dashboard()?>cars/" class="nav-link pe-0 text-muted" target="_blank">العربيات</a>
                </li>
              </ul>
            </div>
          </div>

            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                ...
                <table id="table_id" class="table align-items-center mb-0">
                  <thead>
                    <tr>
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">تعديل</th>
               ...
               <?php  $sql = "SELECT * FROM `receipt`   ";
                    ...
                    <tr>
                    <td>
                    <a href="../edit/receipt.php?code=<?=$row['id']?>">
                      <p class="text-secondary text-xs font-weight-bold">تعديل</p> </a>
                      </td>
                    <td>

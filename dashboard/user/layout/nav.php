  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-end me-3 rotate-caret" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="index.php">
        <img src="https://cdn-icons-png.flaticon.com/128/3135/3135715.png" class="navbar-brand-img h-100" alt="main_logo">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          ...
          <div class="collapse " id="expenses">
            ...
            <li class="nav-item ">
                <a class="nav-link " href="<?=DashboardUser()?>expenses/index.php">
              ...
              <li class="nav-item ">
                <a class="nav-link " href="<?=DashboardUser()?>expenses/add.php">
                  <span class="sidenav-mini-icon">  </span>
        ...
        <li class="nav-item">
          ...
          <div class="collapse " id="componentsExamples">
            ...
            <li class="nav-item ">
                <a class="nav-link " href="<?=DashboardUser()?>collectors/receipt-index.php">
                  <span class="sidenav-mini-icon">  </span>
                  <span class="sidenav-normal"> عرض </span>
                </a>
              </li>
        ...
        <li class="nav-item">
          ...
          <div class="collapse " id="employees">
            ...
            <li class="nav-item ">
                <a class="nav-link " href="<?=DashboardUser()?>employees/index.php">
                  <span class="sidenav-mini-icon">  </span>
            ...
            <li class="nav-item ">
                <a class="nav-link " href="<?=DashboardUser()?>employees/outlay-index.php">
                  <span class="sidenav-mini-icon">  </span>
              ...
              <li class="nav-item ">
                <a class="nav-link " href="<?=DashboardUser()?>employees/outlay.php">
                  <span class="sidenav-mini-icon">  </span>
                  <span class="sidenav-normal"> إضافة </span>
                </a>
              </li>
        ...
        <li class="nav-item">
          ...
          <div class="collapse " id="collectors">
            ...
            <li class="nav-item ">
                <a class="nav-link " href="<?=DashboardUser()?>collectors/index.php">
                  <span class="sidenav-mini-icon">  </span>
                  <span class="sidenav-normal"> عرض </span>
                </a>
              </li>
            ...
            <li class="nav-item ">
                <a class="nav-link " href="<?=DashboardUser()?>collectors/payer.php">
                  <span class="sidenav-mini-icon">  </span>
              ...
              <li class="nav-item ">
                <a class="nav-link " href="<?=DashboardUser()?>collectors/add.php">
                  <span class="sidenav-mini-icon">  </span>
                  <span class="sidenav-normal"> إضافة </span>
                </a>
              </li>
              ...
              <li class="nav-item ">
                <a class="nav-link " href="<?=DashboardUser()?>collectors/duration-index.php">
                  <span class="sidenav-mini-icon">  </span>
        ...
        <li class="nav-item">
          ...
          <div class="collapse " id="customers">
            ...
            <li class="nav-item ">
                <a class="nav-link " href="<?=DashboardUser()?>customers/index.php">
                  <span class="sidenav-mini-icon">  </span>
                  <span class="sidenav-normal"> عرض </span>
                </a>
              </li>
              ...
              <li class="nav-item ">
                <a class="nav-link " href="<?=DashboardUser()?>customers/add.php">
                  <span class="sidenav-mini-icon">  </span>
                  <span class="sidenav-normal"> إضافة </span>
                </a>
              </li>
        ...
        <li class="nav-item">
          ...
          <div class="collapse " id="cars">
            ...
            <li class="nav-item ">
                <a class="nav-link " href="<?=DashboardUser()?>cars/index.php">
                  <span class="sidenav-mini-icon">  </span>
                  <span class="sidenav-normal"> عرض </span>
                </a>
              </li>
              ...
              <li class="nav-item ">
                <a class="nav-link " href="<?=DashboardUser()?>cars/add.php">
                  <span class="sidenav-mini-icon">  </span>
                  <span class="sidenav-normal"> إضافة </span>
                </a>
              </li>

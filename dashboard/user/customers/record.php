<?php include '../layout/head.php';
      ...
      if (!isset($_GET['code'])) {
        ...
        echo error_page('Id Found') ;
            ...
            $sql = "SELECT id , `name`  FROM `customers` where  id = $code ";
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>سجل العميل  <strong> <?=$row['name']?></strong></h6>
            </div>
            ...
            <div class="card-body px-0 pt-0 pb-2">
              ...
              <table id="table_id" class="table align-items-center mb-0">
                  ...
                  <tbody>
               <?php  $sql = "SELECT * FROM `receipt`  where UserID = '$UserIdLogin' AND customerID =$code  ";
                      $result = $conn->query($sql);

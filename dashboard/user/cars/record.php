<?php include '../layout/head.php';
      ...
      if (!isset($_GET['code'])) {
        ...
        echo error_page('Id Found') ;
            ...
            $sql = "SELECT id , Brand , Model  FROM `cars`where  id = $code ";
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>سجل حركة العربية <strong> <?=$row['Brand']?> / <?=$row['Model']?> </strong></h6>
            </div>
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                ...
                <table id="table_id" class="table align-items-center mb-0">
                  ...
                  <tbody>
               <?php  $sql = "SELECT * FROM `receipt`  where UserID = '$UserIdLogin' AND carsID =$code  ";
                      $result = $conn->query($sql);
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center">
                        <p class="text-secondary text-xs font-weight-bold"><?=CarsBrand($row['carsID'])?> / <?=CarsCategory($row['carsID'])?> / <?=CarsModel($row['carsID'])?></p>
                      </td>
                      <td class="align-middle text-center">
